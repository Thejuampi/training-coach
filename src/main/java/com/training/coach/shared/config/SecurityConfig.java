...
public class SecurityConfig {
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http.csrf(ServerHttpSecurity.CsrfSpec::disable)
                .authorizeExchange(auth -> auth
                        ...
                        .pathMatchers(HttpMethod.POST, "/api/integrations/ai/suggestions").hasAnyRole("COACH", "ADMIN")
                        .pathMatchers("/api/integrations/**").hasRole("ADMIN")
                        .pathMatchers("/api/sync/**").hasAnyRole("COACH", "ADMIN")
                        .pathMatchers("/api/training-plans/**").hasAnyRole("COACH", "ADMIN")
                        .pathMatchers("/api/analysis/**").hasAnyRole("COACH", "ADMIN")
                        .pathMatchers("/api/intensity/**").hasAnyRole("COACH", "ADMIN")
                        .pathMatchers("/api/athletes/**").hasAnyRole("COACH", "ADMIN")
                        .pathMatchers("/api/activities/**").hasAnyRole("COACH", "ATHLETE", "ADMIN")
                        .pathMatchers("/api/wellness/**").hasAnyRole("COACH", "ATHLETE", "ADMIN")
                        .pathMatchers("/api/notes/**").hasAnyRole("COACH", "ATHLETE", "ADMIN")
                        .pathMatchers("/athletes/**").hasAnyRole("COACH", "ADMIN")
    ...
    @Bean
    public ReactiveJwtDecoder reactiveJwtDecoder(JWKSource<SecurityContext> jwkSource) {
